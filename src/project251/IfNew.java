...
//     if (Email.contains("A") &&(userName.contains("aA")) && (Password.contains("1") &&(conPassword.contains("7") && (firstName.contains("AB") &&
//           (lastName.contains("Al-") && (Address.contains("Jeddah") && (phoneNum.contains("0509535041") ){
